...
export const resolveMediaUrlFromAsset = (media, preferred = 'thumb') => {
  if (!media) return '';
  const variants = media.variants || {};
  const variantUrl = pickVariant(variants, preferred) || pickVariant(variants, 'cover') || pickVariant(variants, 'card');
